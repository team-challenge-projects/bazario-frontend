          ...
          <div className='flex flex-col gap-2'>
            {footerCategories.map((category, id) => (
              <Link
                key={id}
                href={`#`}>
                <p className='text-secondary text-[18px] leading-[27px] font-semibold flex items-center gap-3.5'>
                  {category.text}{" "}
          ...
          <div className='flex flex-col gap-2'>
            {footerHelp.map((category, id) => (
              <Link
                ...
                <p className='text-secondary text-[18px] leading-[27px] font-semibold'>
                  {category.text}
                </p>
              </Link>
            ))}
