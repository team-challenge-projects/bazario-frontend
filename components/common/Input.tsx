...
const Input: FC<InputProps> = ({ placeholder, icon, type }) => {
  ...
  return (
    <div
      className={`${
        type !== "search"
          ? "w-[443px] border-[1px] border-custom-light-grey"
          : ""
      } flex items-center justify-between py-[14px] px-5 rounded-full hover:border-[1px] hover:border-custom-light-grey
                ${
