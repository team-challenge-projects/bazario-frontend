...
const GoodSmallCard = () => {
  return (
    <Card className="rounded-[20px] border-none bg-transparent shadow-none">
      ...
      <CardContent className="flex justify-between pb-2 text-[18px]/[27px] font-semibold">
        <p>Назва товару</p>
        <p>70 &#8372;</p>
      </CardContent>
      <CardFooter className="flex justify-between text-[14px]/[110%] font-medium text-custom-dark-grey">
        <p>12 грудня 2023</p>
        <p>⭐ 7/10 </p>
      </CardFooter>
    </Card>
